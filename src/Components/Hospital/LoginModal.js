...
import { ModalContainer, ModalOverlay, ModalContent, ModalCloseBtn } from "./Modal";
...
function LoginModal({ onClose, onLogin,isLogin, setIsLogin, userId, setUserId, password, setPassword, mbClick }) {
